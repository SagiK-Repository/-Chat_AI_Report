문서정보 : 2023.05.25.~05.31. 작성, 작성자 [@SAgiKPJH](https://github.com/SAgiKPJH)
...
## 활용 요령
- 코드를 작성하는데 활용하면 좋은 내용을 3가지로 간단히 정리해 보았습니다.
  1. 명확한 질문 - 항목으로 질문하기
  2. 질문에 대한 추가 정보 제공하여 질문하기
  3. 명확한 대답 요청 - 조건을 대입하여 질문하기
...
### 질문에 대한 추가 정보 제공하여 질문하기
- 원하는 정보에 대한 사전 지식을 대화를 통해 설정합니다.
- 예시
  ```bash
  OpenCV는 무엇이야?
  ```  
...
- 예시
  ...
  코드를 C#, Xaml 모두 보여줘.
  3단계에 걸쳐서 설명해줘
  1단계는 환경 설정 방법, 2단계는 C#코드, 3단계는 XAML코드를 구성해줘.
  코드 전체를 보여줘.
  한글로 출력해줘.
  ```
- 결과  
...
- 본인은 GPT Chat, Bing AI를 가장 많이 씁니다.
- 인터넷 검색을 활용하기엔 BingAI가 좋습니다.
- wrtn은 아직 정확한 정보를 기대하기에는 부족하다 생각합니다. 속도도 느린 편입니다.

<br>

## 마무리
- 여러 chat AI가 나타나는 중에, 본인이 비교하고 싶어서 간단히 비교한 내용입니다.
- 위 내용중에서 놓친 부분이 있거나, 조금 고려해야 할 사항이 있을 경우 [의견 주시면](https://github.com/SagiK-Repository/Chat_AI_Report/issues) 감사하겠습니다!
